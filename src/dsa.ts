...
export default class DiscordSecurityAgency {
    ...
    prepareUserMessageData(messages: { channelId: string; attachmentCount: number; embedCount: number; content: string; createdAt: Date; }[]) {
        ...
        const tokenBlacklist: string[] = ["a", "the", "and", "is", "to", "of", "in", "for", "on", "with", "as", "by", "at", "this", "that", "it", "an", "are", "i", "you", "he", "she", "we", "they", "them", "my", "your", "his", "her", "its", "our", "their", "there", "where", "when", "why", "how", "what", "who", "which", "up", "down", "left", "right", "here", "there", "now", "then", "so", "but", "or", "if", "not", "no", "yes", "maybe", "like", "just", "really", "very", "be", "have", "has", "had", "do", "does", "did", "doing", "go", "goes", "went", "going", "come", "comes", "came", "coming", "see", "sees", "saw", "seeing", "say", "says", "said", "tell", "tells", "told", "think", "thinks", "thought", "me"];
        const tokenCounts: Record<string, number> = {};
        tokens.forEach((token) => {
            if (tokenBlacklist.includes(token.toLowerCase())) {
                return;
            }
